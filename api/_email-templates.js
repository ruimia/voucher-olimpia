const HEADER_IMG = 'https://vale.olimpiaspa.com/public/images/email-header.png';
const FOOTER_IMG  = 'https://vale.olimpiaspa.com/public/images/email-footer.png';
...
<div style="max-width:600px;margin:0 auto;background:#fff;">
  ...
  <div style="padding:24px 32px;text-align:center;">
    ...
    <p style="font-size:0.9rem;color:#555;margin:0 0 4px;">Agende em <a href="http://www.olimpiaspa.com" style="color:#d4a96a;">OlimpiaSpa.com</a></p>
    <p style="font-size:0.85rem;color:#d4a96a;font-style:italic;margin:0 0 8px;">(válido por 90 dias)</p>
    <p style="font-size:0.9rem;color:#333;margin:0;">Jardins ou Vila Olímpia:<br><strong>(11) 2122-4027</strong> ou WhatsApp <strong>(11) 98704-9281</strong></p>
  </div>
...
<div style="max-width:600px;margin:0 auto;background:#fff;">
  ...
  <div style="padding:24px 32px;text-align:center;">
    ...
    <p style="font-size:1rem;color:#666;font-style:italic;margin:0 0 20px;">Você acaba de ganhar um tratamento no Olímpia Spa</p>
    <div style="text-align:left;background:#faf7f3;border-radius:6px;padding:16px 20px;margin-bottom:16px;border:1px solid #ede6da;">
      ...
      <p style="margin:0 0 8px;font-size:1rem;"><strong>Mensagem:</strong><br><em>"${mensagem}"</em></p>
      <p style="margin:0;font-size:1rem;"><strong>Descrição do pacote:</strong><br>${(descricao || '').replace(/\n/g, '<br>')}</p>
    </div>
    <div style="background:#2c2c2c;border-radius:6px;padding:14px 20px;margin-bottom:20px;">
      <p style="font-size:0.7rem;text-transform:uppercase;letter-spacing:1px;color:#d4a96a;margin:0 0 4px;">Código Vale-Presente:</p>
      <p style="font-size:2rem;font-weight:bold;letter-spacing:4px;color:#fff;margin:0 0 4px;">#${codigo}</p>
      <p style="font-size:0.75rem;color:#aaa;font-style:italic;margin:0;">(Guarde esse número para agendamento dos tratamentos)</p>
    </div>
    <p style="font-size:0.9rem;color:#555;margin:0 0 4px;">Veja os tratamentos em <a href="http://www.olimpiaspa.com" style="color:#d4a96a;">OlimpiaSpa.com</a>, ligue e agende</p>
    <p style="font-size:0.85rem;color:#d4a96a;font-style:italic;margin:0 0 8px;">(válido por 90 dias)</p>
    <p style="font-size:0.9rem;color:#333;margin:0;">Jardins ou Vila Olímpia:<br><strong>(11) 2122-4027</strong> ou WhatsApp <strong>(11) 98704-9281</strong></p>
  </div>
  <img src="${FOOTER_IMG}" alt="" style="width:100%;display:block;" />
...
module.exports = { emailTemplate, emailTemplatePrePag };
