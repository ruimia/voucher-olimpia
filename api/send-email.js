...
module.exports = async function handler(req, res) {
  ...
  const { to, cc, para, de, descricao, mensagem, codigo, pdfBase64 } = req.body;
  ...
  try {
    const result = await resend.emails.send({
      ...
      to: [to],
      cc: cc ? [cc] : [],
      subject: `Vale-Presente para ${para} — #${codigo}`,
      html: emailTemplate({ para, de, mensagem, descricao, codigo }),
